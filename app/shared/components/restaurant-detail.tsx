          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            <div className="flex flex-col-reverse">
              ...
              <div>
                  ...
                  {[0, 1, 2, 3, 4].map((rating) => (
                    <StarIcon
                      ...
                      className={classNames(
                        Number(restaurant.restaurantAvgRating) > rating
                          ? "text-yellow-400"
                          : "text-gray-300",
                ...
                <p className="sr-only">
                  {restaurant.restaurantAvgRating} out of 5 stars
                </p>
              </div>
            </div>

            <p className="mt-6 text-gray-500">{restaurant.phoneNumber}</p>
            ...
            <Tab.Group as="div">
              ...
              <Tab.Panels as={Fragment}>
                <Tab.Panel className="-mb-10">
                  ...
                  {restaurant.RestaurantReviews.map((review, reviewIdx) => (
                    <div
                      key={review.id}
